<script lang="ts" context="module">
	export const ServiceTypeDisplay: EntityDisplayComponent<TypeMetadata<ServicedDefinitionMetadata>> = {
		...
		getDescription: (serviceType: TypeMetadata<ServicedDefinitionMetadata>) => serviceType.description,
		getIcon: (serviceType: TypeMetadata<ServicedDefinitionMetadata>) => serviceDefinitions.getIconComponent(serviceType.id),
...
<script lang="ts">
	...
	import { serviceDefinitions, type ServicedDefinitionMetadata, type TypeMetadata } from '$lib/shared/stores/metadata';
