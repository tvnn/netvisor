...
async fn create_node_group(
    ...
    let group = NodeGroup {
        ...
        auto_diagnostic_enabled: request.auto_diagnostic_enabled.unwrap_or(true),
    };
...
async fn update_node_group(
    ...
    if let Some(node_sequence) = request.node_sequence {
        group.node_sequence = node_sequence;
    }
    if let Some(auto_diagnostic_enabled) = request.auto_diagnostic_enabled {
        group.auto_diagnostic_enabled = auto_diagnostic_enabled;
    }
