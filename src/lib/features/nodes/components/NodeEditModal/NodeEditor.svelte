<script lang="ts">
  ...
  import type { Node, AssignedTest } from "$lib/components/nodes/types/types";
  import { createEmptyNodeFormData, nodeToFormData, formDataToNodeApi } from "$lib/components/nodes/types/types";
  import EditModal from '../../shared/EditModal.svelte'
