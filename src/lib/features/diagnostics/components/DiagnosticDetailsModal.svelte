<script lang="ts">
  import { 
	...
	import type { DiagnosticExecution, NodeResult } from '../types/base';
	import { nodeGroups } from '$lib/features/node_groups/store';
	import EditModal from '$lib/shared/components/forms/EditModal.svelte';
	import { diagnosticStatuses } from '$lib/shared/stores/registry';
	import { formatDuration, formatTimestamp } from '$lib/shared/utils/formatting';
	import { nodes } from '$lib/features/nodes/store';
	import JsonContainer from '$lib/shared/components/forms/JsonContainer.svelte';
  ...
  $: statusColors = diagnosticStatuses.getColor(execution?.status || null);
