...
<script context="module" lang="ts">
  export const INPUT_BASE_CLASSES = "w-full px-3 py-2 bg-gray-700 border rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed";
