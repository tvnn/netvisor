<script lang="ts">
  ...
  import type { Node, AssignedTest } from "$lib/components/nodes/types";
  import { createEmptyNodeFormData, nodeToFormData, formDataToNodeApi } from "$lib/components/nodes/types";
